                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="text-center text-md-left">
                            <button type="submit" name="submit" class="btn btn-success" style="color: var(--main-bg-color)">Sign Up</button>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="text-center text-md-right">
                            <a style="color: var(--accent-color)" href="<?php echo base_url("SignIn")?>">Already have an account</a>
                        </div>
                    </div>
                </div>
